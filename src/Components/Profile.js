  ...
  return (
    <div className="flex flex-col lg:flex-row items-center my-10 w-fit bg-slate-300 mx-auto p-3 rounded-lg">
      <div className="lg:pr-3 mb-5 lg:m-0">
        <img
          src={user ? photoURL : 'https://cdn.vectorstock.com/i/1000x1000/25/72/picture-coming-soon-icon-vector-31612572.webp'}
          alt="Profile"
      ...
      <div className="flex flex-col">
        ...
        <div className="flex items-center gap-3">
          <p>Email Verified :</p>
          <span className="dark:text-gray-400">{emailVerified}</span>
        </div>
      </div>
    </div>
  );
